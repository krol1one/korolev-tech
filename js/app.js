...
const CASES_FALLBACK = [
  ...
  },
  {
    ...
    "stack": ["Telegram Bot API", "Node.js", "Docker", "Docker Compose", "SQLite", "SaleBot Rich Message API", "Linux server", "polling"],
  ...
  },
  {
    ...
    "stack": ["Node.js", "Telegram Bot API", "SQLite", "systemd", "Next.js", "TypeScript"],
  ...
  },
  {
    ...
    "stack": ["Python 3.12", "aiogram 3", "asyncio", "FFmpeg", "ffprobe", "SQLAlchemy 2 async", "SQLite", "Alembic", "pydantic-settings", "Docker", "Docker Compose", "pytest", "ruff", "mypy", "structlog"],
  ...
  },
  {
    ...
    "stack": ["Next.js 16", "TypeScript", "Tailwind CSS", "App Router", "Telegram Bot API", "Telegram Mini Apps", "SQLite", "Node.js", "systemd", "Cloudflare Tunnel"],
    "projectUrl": "https://t.me/proliv_tea_bot",
  ...
  },
  {
    ...
    "stack": ["HTML", "CSS", "JavaScript", "JSON", "GitHub Pages", "CNAME", "SEO", "Telegram Bot API", "Python", "systemd"],
...
async function loadCases() {
  ...
  try {
    const response = await fetch("./data/cases.json?v=20260803-two-tuna-miniapp", { cache: "no-store" });
